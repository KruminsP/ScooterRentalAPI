...
namespace ScooterRentalAPI
{
    public class RentalCompany : IRentalCompany
    {
        ...
        private static List<RentedScooters> _rentedScooters = new List<RentedScooters>();
        ...
        public static RentedScooters StartRent(int id)
        {
            ...
            var rentedScooter = new RentedScooters(scooter.Id, DateTime.UtcNow, scooter.PricePerMinute);
        ...
        public static List<RentedScooters> GetAllRentedScooters()
        {
